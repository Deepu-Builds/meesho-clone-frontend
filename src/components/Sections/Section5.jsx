...
return(
   ...
   <div>
    ...
    <Link className="Hover-effect"><img src="https://images.meesho.com/images/marketing/1744635870215.webp" alt="Earrings" /><h1 className="flex justify-center items-center text-[#43003b] bg-white border border-yellow-500 rounded-[7px] font-bold transition duration-100 h-[30px] relative top-[7px]">Earring</h1></Link></div>
